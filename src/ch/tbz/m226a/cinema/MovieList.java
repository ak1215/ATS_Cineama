...
public class MovieList {
    ...
    public void addMovie() {
        ...
        listOfMovie.add(new Movie("DIE SCHÖNSTEN JAHRE MEINES LEBENS", "2020-11-11", "18:00", "Englisch", Location.Stadelhofen));
        listOfMovie.add(new Movie("I STILL BELIEVE", "2020-09-20", "16:00", "Englisch", Location.Stadelhofen));
        listOfMovie.add(new Movie("JEAN SEBREG - AGAINST ALL ENEMIES", "2020-01-01", "22:00", "Englisch", Location.Winterthur));
        listOfMovie.add(new Movie("JUST MERCY", "2020-03-09", "12:00", "Englisch", Location.Winterthur));
